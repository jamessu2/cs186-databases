 ...
 *
 */
object FileConsumer extends Logging {

  def main(args: Array[String]) {
    val parser = new OptionParser
     val outputFileOpt = parser.accepts("output-file", "The topic id to consume on.")
            .withRequiredArg
   ...
   val whitelistOpt = parser.accepts("whitelist", "Whitelist of topics to include for consumption.")
    ...
    val OUTPUTFILENAME = options.valueOf(outputFileOpt)
