...
### 1. This assignment was pushed late, but within 24 hours of the deadline in regards to the hw1.sh, hw1_first.py, and hw1_second.py files. As a result, I would like to choose to use 1 slip day on this assignment.
### 2. I have a total of 4 slip days before this assignment, so now I should have 3 after submitting this assignment late.
